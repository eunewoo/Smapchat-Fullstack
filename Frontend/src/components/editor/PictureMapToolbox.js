    ...
    return (
        <Card className="inner">
            ...
            <Container style={{padding: "20px"}}>
                ...
                <Button
                    className="inner"
                    onClick={() => props.handler.createTrans(`Location[${props.index}].Library`, {
                        "Name" : "",
                        "Images" : [],
                    })}>
                    Add new
        ...
        <Card className="inner">
            <Card.Body style={{backgroundColor: "#141488", color: "white", height: "40px", padding: "5px"}}>
                <input 
                    ...
                    onChange={(val) => props.handler.updateTrans(`Location[${props.parentIndex}].Library[${props.index}].Name`, val.target.value)}/>
                <BsXLg 
                    className="invisibleButton"
                    onClick={(val) => props.handler.deleteTrans(`Location[${props.parentIndex}].Library`, props.library)}/>
            </Card.Body>
            ...
            <Container>
                ...
                <Button
                    ...
                    onClick={() => props.handler.createTrans(`Location[${props.parentIndex}].Library[${props.index}].Images`, "n")}>
    ...
    return (
        <div style={{display:"inline-block", position:"relative", width: "129px", height: "100px", margin: "5px"}}>
            ...
            <Button 
                ...
                onClick={(val) => props.handler.deleteTrans(`Location[${props.parentIndex}].Library[${props.index}].Images`, props.src)}>
                <BsXLg/>
            </Button>
        </div>
    );
