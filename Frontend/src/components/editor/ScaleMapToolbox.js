        ...
        <Card className="inner">
            <Card.Body style={{backgroundColor: "#141488", color: "white", height: "40px", padding: "5px"}}>
                ...
                <BsXLg 
                    ...
                    onClick={(val) => props.handler.deleteTrans('Location', props.scalePointLocation)}/>
            </Card.Body>
            <Container style={{padding: "20px"}}>
                <input 
                    ...
                    onChange={(val) => props.handler.updateTrans(`Location[${props.index}].Value`, val.target.value)}/>
