...
export default function Comment(props) {
    ...
    if (Object.keys(commentData).length === 0)
    {
        setCommentData(
            {
                content: "This map is really cool! I like it a lot! asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, asdsadasdwafs sadas safassfaasasf, fsih, sda, w da, ",
                date: "1/1/1970"
            }
        )
    ...
    return (
      <div className="Comment">
        ...
        <Card style={{width: "100%", border: "none"}}>
            <Card.Body>
            <Card.Title>{commentUser.username ?? "Loading..."}</Card.Title>
            <Card.Subtitle className="mb-2 text-muted"> on {commentData.date}</Card.Subtitle>
            <Card.Text>{commentData.content ?? "Loading..."}</Card.Text>
            </Card.Body>
        </Card>
